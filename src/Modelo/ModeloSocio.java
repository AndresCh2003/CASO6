...
public class ModeloSocio extends Socios {
    ...
    public boolean crearSocio() {
        try {
            ...
            sql = "INSERT INTO socio (soc_cedula,soc_nombres, soc_direccion, soc_telefono,soc_disco, soc_placa, soc_marca, soc_imagen)";
            sql += "VALUES(?,?,?,?,?,?,?,?)";
    ...
    public List<Socios> listaSociosTabla() {
        try {
            ...
            while (rs.next()) {
                ...
                socioo.setPer_cedula(rs.getString("soc_cedula"));
                socioo.setNombre(rs.getString("soc_nombres"));
                socioo.setTelefono(rs.getString("soc_direccion"));
                socioo.setDireccion(rs.getString("soc_telefono"));
                socioo.setDiscoTaxi(rs.getString("soc_disco"));
                socioo.setPlacaTaxi(rs.getString("soc_placa"));
                socioo.setMarcaTaxi(rs.getString("soc_marca"));
                bytea = rs.getBytes("soc_imagen");
...
//    }
    public boolean eliminar(String cedula) {
        ...
        String sql = "DELETE FROM socio WHERE soc_cedula = '" + cedula + "';";
